...
def server(_args):
    ...
    uvicorn.run('httpbinx.main:app', host=_args.host, port=_args.port)


def execute():
    """Execute the CLI."""
    parser = argparse.ArgumentParser(prog='httpbinx', description='httpbinx is a fastapi server for testing.')
    ...
    parser_server.add_argument('--host', type=str, help='host', default='0.0.0.0')
    parser_server.add_argument('--port', type=int, help='port', default=80)
